...
Row: `TASKS.md` → TASK-NNN. This brief is the task's long form: the row keeps a link and one
sentence, everything else lives here (spec 001 §14 A15, AC-34). Scaffold it with
`pnpm tasks:brief TASK-NNN`; keep it current by editing this file, not the row.
